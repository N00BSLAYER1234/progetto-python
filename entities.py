...
class Spike(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, width=32, height=32):
        super().__init__()
        # Create a simple spike representation (gray triangular spikes)
        self.image = pygame.Surface((width, height))
        self.image.fill((60, 60, 60))  # Dark gray
        # Draw simple spike pattern
        pygame.draw.polygon(self.image, (180, 0, 0), [(0, height), (width//2, 0), (width, height)])
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y, movement_range=100):
        super().__init__()
        ...
        if assets:
            # Randomly choose between green and orange slime
